 ...
 *  - При виникненні помилки в процесі виконання запиту (наприклад, мережева помилка), логувати помилку у консоль і повертати 
 *    текст помилки.
 *
 * 4. Логування:
...
const data = {question: "The Ultimate Question of Life, the Universe, and Everything", answer: 42 };
const id = 5;
...
async function getData(segment) {
  ...
  try {
    ...
    if (!response.ok){
      ...
      console.log("----------------------- Get Data Example -----------------------");
      console.log(response.status);
      console.log(data);
      // code here
    }
  } catch (error) {
    console.log("error fetch from : " + baseUrl );
    // code here
  }
}
...
async function postData(segment, data) {
  ...
  try {
    ...
    // code here
    console.log("error post to : " + baseUrl );
  }
}
...
async function putData(id, data) {
  ...
  try {
    ...
    // code here
    console.log("error put to : " + baseUrl );
  }
}
...
async function patchData(id, data) {
  ...
  try {
    ...
    if (!response.ok){
      ...
      console.log("----------------------- Patch Data Example -----------------------");
      console.log(response.status);
      // code here
    }
  } catch (error) {
    // code here
    console.log("error patch to : " + baseUrl );
  }
}
...
async function deleteData(id) {
  ...
  try {
    ...
    if (!response.ok){
      ...
      console.log("----------------------- Delete Data Example -----------------------");
      console.log(response.status);
      // code here
    }
  } catch (error) {
